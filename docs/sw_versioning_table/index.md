...
## Table
This table has been generated automatically by processing data available in [`robotology/robotology-superbuild@v2025.11.1/releases`](https://github.com/robotology/robotology-superbuild/tree/v2025.11.1/releases).

Click on the distros below to explore their package versions:

- [📦 Distro **2025.11.1**](./2025.11.1.md){:target="_blank"}
- [📦 Distro **2025.11.0**](./2025.11.0.md){:target="_blank"}
