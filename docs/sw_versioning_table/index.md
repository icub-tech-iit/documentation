...
For example, to download the SW Distro `2020.11` do:
```sh
$ git clone https://github.com/robotology/ycm.git -b v0.12.0
$ git clone https://github.com/robotology/yarp.git -b v3.4.0
$ git clone https://github.com/robotology/icub-main.git -b v1.18.0
 ...
```
