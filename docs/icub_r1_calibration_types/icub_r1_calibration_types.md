...
The aims of this document is to give to expert user some technical information about all calibration types used on `R1` and `iCub` robots based on Ethernet. 
