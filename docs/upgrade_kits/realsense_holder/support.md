...
Check out the [STL and STEP files]([assets/realsense_holder.zip](https://github.com/icub-tech-iit/documentation/raw/master/docs/upgrade_kits/realsense_holder/assets/realsense_holder.zip) of the holder. 
