...
[`xcub-moveit2`](https://github.com/mesh-iit/xcub-moveit2) contains ROS 2 packages to control a YARP-based robot (iCub/ergoCub) with MoveIt2 platform.
[Check it out](https://github.com/mesh-iit/xcub-moveit2/blob/master/README.md) for more details.
