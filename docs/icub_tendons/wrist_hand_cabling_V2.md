...
|<img src="../img/HAND_WRIST_V2/Opposite_palm-view.png" width="400"><img src="../img/HAND_WRIST_V2/R_Th-opp-d-view.png" width="400"><br/><img src="../img/HAND_WRIST_V2/L_Th_holes_S.png" width="300">|<u>STEP 4: </u><br/>Insert both sides of the cable inside S2 and S0 <br/>until they sprout out from the palm side. Remember that S0 is the shorter sheath and S2 is the longer one. BE CAREFUL! The right hand is not symmetrical.|
