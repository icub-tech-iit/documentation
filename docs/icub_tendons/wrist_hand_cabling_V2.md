...
| <img src= "../img/HAND_WRIST_V2/tie_wrap.png" width = 130%> | <u>STEP 6:</u> <br/>Put a 2 tie wraps one for each side (or cable) in order to prevent them from getting untwisted. |
