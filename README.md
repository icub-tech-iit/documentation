...
First off, sign up for Gitpod using your GitHub credentials. You'll have 50 hours/month of free usage on public and private repositories. Also, remember to visit the [Gitpod Integrations](https://gitpod.io/integrations) to make sure that all GitHub options are ticked in.
...
⚠️ When forking the repository, remember to copy out all the branches. Then, follow the steps below, where you have to correctly fill up the signature `your-fork`:
