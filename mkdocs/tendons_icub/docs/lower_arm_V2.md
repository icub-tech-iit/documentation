...
| <img src ="/img/lowerArm/wiring_prox_pulley3.png" width=400> <img src ="/img/lowerArm/wiring_prox_pulley.png" width=400><br /> <img src ="/img/lowerArm/wiring_prox_pulley2.png" width=400> | Respect the only one rule: 2 full turns around the pulley for the hole close to the ball bearing (blue cable) and 1 full turn for the part that will go into the hole the closest from the motor (red cable). |
=======
...
| <img src ="/img/lowerArm/holes_prox.png" width=900> | After wrapping the cable on the pulley, insert the 2 cable extremities inside the frame holes. For the thumb, the frame holes are designed inclined by 45 deg. |
| <img src ="/img/lowerArm/exit_prox.png" width=700>              | Push the 2 sides of the cable inside the sheath (+) and (-) for each finger. |
